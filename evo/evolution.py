...
class EvolutionEngine:
    ...
    def __init__(self, config: 'EvolutionaryConfig', deck_config: 'DeckEvolutionConfig' = None):
        ...
        if self.deck_config:
            print(f"Using evolutionary deck configuration")
    ...
    def initialize(self):
        ...
        # Initialize fitness evaluator with deck config
        self.fitness_evaluator = FitnessEvaluator(self.config, self.deck_config)
    ...
    def run(self) -> Dict[str, Any]:
        ...
        while not self.population.should_terminate():
            ...
            fitness_scores = self.fitness_evaluator.evaluate_population(all_individuals, self.population.generation)
            ...
            if self.population.generation % self.config.checkpoint_interval == 0:
    ...
    def _save_results_summary(self, results: Dict[str, Any]):
        ...
        with open(summary_file, 'w') as f:
            ...
            f.write(f"Max game length: {self.config.max_turns}\n\n")
